	...
	{if !isset($content_only) || !$content_only}
		...
		<div id="page">
			<div class="header-container">
			   {if $page_name =='index' && $page_name !='pagenotfound' && $isMobile == 0}
				<div id="slider_row">
				...
				<header id="header">
				 ...
				 {if $page_name =='index' && $page_name !='pagenotfound' && $isMobile == 1}
				<div id="slider_row" class="slide-mobile">
					  <div id="top_column" class="center_column">{hook h="displayTopColumn"}</div>
				</div>
				{/if}
				{capture name='displayBottomTop'}{hook h='displayBottomTop'}{/capture}
				{if $smarty.capture.displayBottomTop}
					{if $page_name == 'index'}
						<div class="bottom-top">
							{$smarty.capture.displayBottomTop}
						</div>
					{/if}
				{/if}
			</div>
			...
			<div class="columns-container">
				<div id="columns" class="container">
					<div class="row">
						...
						{capture name='displayTopHome'}{hook h='displayTopHome'}{/capture}
						{if $smarty.capture.displayTopHome}
							{if $page_name =='index'}
								{$smarty.capture.displayTopHome}
							{/if}
						{/if}						
	{/if}
