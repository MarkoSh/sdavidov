...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').removeClass('col-lg-3');
		$('.product_list > li').removeClass('col-md-4');
		$('.product_list > li').removeClass('col-sm-6');
		$('.product_list > li').addClass('col-xs-12');
		
		$('.product_list > li').each(function(index, element) {
			html = '';
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-xs-4 col-xs-5 col-sm-4">' + $(element).find('.left-block').html() + '</div>';
				html += '<div class="right-block col-xs-4 col-xs-12 col-sm-8"><div class="right-block-content">';
