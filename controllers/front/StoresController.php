...
class StoresControllerCore extends FrontController
{
    ...
    public function setMedia()
    {
        ...
        if (!Configuration::get('PS_STORES_SIMPLIFIED')) {
            ...
            $this->addJS('http'.((Configuration::get('PS_SSL_ENABLED') && Configuration::get('PS_SSL_ENABLED_EVERYWHERE')) ? 's' : '').'://maps.google.com/maps/api/js?key=AIzaSyAogIprIYMhgvpa7PkvS-uBoC2WqEyn350&sensor=true&region='.substr($default_country->iso_code, 0, 2));
