...
<section>
    <p>
        ...
        {if {l s='FRONTEND_MESSAGE_PLEASE_BACK_AGAIN' mod='skrill'} == "FRONTEND_MESSAGE_PLEASE_BACK_AGAIN"}Please back again after a minutes and check your order history{else}{l s='FRONTEND_MESSAGE_PLEASE_BACK_AGAIN' mod='skrill'}{/if}
        {else}
