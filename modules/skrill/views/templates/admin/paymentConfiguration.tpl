...
<div class="panel">
	<div class="form-group border-none">
		<div class="col-lg-2 logo-wrapper">
			<img src="{$thisPath|escape:'htmlall':'UTF-8'}views/img/{$payments.0.type|escape:'htmlall':'UTF-8'}.png" alt="{$payments.0.type|escape:'htmlall':'UTF-8'}" class="payment-config-logo">
		</div>
