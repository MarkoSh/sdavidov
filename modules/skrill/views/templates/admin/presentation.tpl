...
<div class="panel panel-presentation">
	<div class="pres-header-group">
		...
		<div class="col-lg-3 pres-header-logo">
			<img src="{$thisPath|escape:'htmlall':'UTF-8'}views/img/skrill.png" alt="wlt" class="pres-logo">
		</div>
		<div class="col-lg-1">&nbsp;</div>
		<div class="col-lg-6">
	...
	<div class="pres-content-wrapper pres-content-bottom">
		<div class="col-lg-4 pres-content">
			...
			<div class="pres-circle">
				<a href="{$signUpUrl|escape:'htmlall':'UTF-8'}" target="_blank" >
					<img src="{$thisPath|escape:'htmlall':'UTF-8'}views/img/signup.png" alt="step-1" class="pres-step-image">
				</a>
			</div>
			<div class="clear"></div>
		...
		<div class="col-lg-4 pres-content">
			...
			<div class="pres-circle">
				<a href="{$guideUrl|escape:'htmlall':'UTF-8'}" target="_blank" >
					<img src="{$thisPath|escape:'htmlall':'UTF-8'}views/img/guide.png" alt="step-3" class="pres-step-image">
				</a>
			</div>
			<div class="clear"></div>
