...
if (!defined('_PS_VERSION_'))
	exit;
require_once (_PS_MODULE_DIR_.'wtblog/classes/WtBlogPost.php');
...
class WtBlogLatestNews extends Module
{
	...
	public function install()
	{
		...
		|| !$this->registerHook('hookdisplayBottomFooter')
		...
		|| !$this->registerHook('actionsbtogglepost'))
			return false;
		Configuration::updateGlobalValue('wtshowhomepost', 1);
		return true;
	}
	...
	public function hookDisplayHome()
	{
		...
		{
			$view_data = array();
			if (!$this->isCached('wtblog_latest_news.tpl', $this->getCacheId('wtblog_latest_news')))
			{
				$view_data['posts'] = WtBlogPost::GetPostLatestHome(Configuration::get('wtshowhomepost'));
				$this->smarty->assign(array(
					'view_data' => $view_data['posts']
				));
			}
			return $this->display(__FILE__, 'wtblog_latest_news.tpl', $this->getCacheId('wtblog_latest_news'));
		}
	}
	public function hookDisplayLeftColumn()
	{
		...
		{
			$view_data = array();
			if (!$this->isCached('wtblog_latest_news_left.tpl', $this->getCacheId('wtblog_latest_news_left')))
			{
				$view_data['posts'] = WtBlogPost::GetPostLatestHome(Configuration::get('wtshowhomepost'));
				$this->smarty->assign(array(
					'view_data' => $view_data['posts']
			...
			return $this->display(__FILE__, 'wtblog_latest_news_left.tpl', $this->getCacheId('wtblog_latest_news_left'));
		}
	}
	...
	public function hookdisplayBlogLastNews()
	{
		return $this->hookDisplayHome();
	}
	...
	public function deleteCache()
	{
		...
		$this->_clearCache('wtblog_latest_news_left.tpl', $this->getCacheId('wtblog_latest_news_left'));
	}
