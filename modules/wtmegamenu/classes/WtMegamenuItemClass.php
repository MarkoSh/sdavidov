...
class WtMegamenuItemClass extends ObjectModel
{
	public $id_column;
	public $type_link;
	public $type_item;
	...
	public $text;
	public $active;
	public $temp_url = '{wt_menu_h_url}';
	public static $definition = array(
		'table' => 'wtmegamenu_item',
		'primary' => 'id_item',
		'multilang' => true,
		'multilang_shop' => true,
		'fields' => array(
	...
	public	function __construct($id_item = null, $id_lang = null, $id_shop = null, Context $context = null)
	{
		...
		Shop::addTableAssociation('wtmegamenu_item', array('type' => 'shop'));
		Shop::addTableAssociation('wtmegamenu_item_lang', array('type' => 'fk_shop'));
		if ($this->id)
		{
	...
	public function getFieldShop($field)
	{
		...
		$sql = 'SELECT wms.'.$field.' FROM '._DB_PREFIX_.'wtmegamenu_item wm
		LEFT JOIN '._DB_PREFIX_.'wtmegamenu_item_shop wms ON (wm.id_item = wms.id_item)
