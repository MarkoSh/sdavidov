...
*}
<form id="module_form" class="defaultForm form-horizontal" action="index.php?controller=AdminModules&amp;configure=wtverticalmegamenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}" method="post" enctype="multipart/form-data" novalidate="">
<div class="panel"><h3><i class="icon-list-ul"></i> {l s='Menu Item' mod='wtverticalmegamenu'}</h3>
	<div class="form-wrapper" id="menuContent" >
		<div class="form-group wt-type-link">
			<label class="control-label col-lg-3">{l s='Type Link' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group wt-menu-title" {if $menu->type_link == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Title' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group wt-menu-link" {if $menu->type_link == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Link' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
		...
		<div class="form-group ps_link" {if $menu->type_link == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='PrestaShop Link' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group show_sub" {if $menu->type_link == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Show Sub Categories' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
		...
		<div class="form-group">
			<label class="control-label col-lg-3">{l s='Sub Title' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
				{foreach from=$languages item=language}
					{if $languages|count > 1}
						<div class="translatable-field lang-{$language.id_lang|intval}" {if $language.id_lang != $id_language}style="display:none"{/if}>
		...
		<div class="form-group wt-type-icon">
			<label class="control-label col-lg-3">{l s='Type Icon' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
				<div class="radio wt-radio">
		...
		<div class="form-group wt-fw-icon" {if $menu->type_icon == 0}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Font-Awesome Icon' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='wtverticalmegamenu'} <a href="http://fortawesome.github.io/Font-Awesome/3.2.1/icons/">http://fortawesome.github.io/Font-Awesome/3.2.1/icons/.</a> ex: icon-sun</p>
			</div>
		</div>
		<div class="form-group wt-img-icon" {if $menu->type_icon == 1}style="display:none"{/if}>
			<label class="control-label col-lg-3">{l s='Image Icon' mod='wtverticalmegamenu'}</label>
			<div class="col-lg-9">
				<div class="col-lg-6">
					...
					{if $menu->type_icon == 0 && isset($menu->icon) && $menu->icon != ''}
						...
						{if isset($menu->id)}
							<a href="index.php?controller=AdminModules&amp;configure=wtverticalmegamenu&amp;tab_module=front_office_features&amp;module_name=wtverticalmegamenu&amp;token={Tools::getAdminTokenLite('AdminModules')|escape:'html':'UTF-8'}&amp;removeIcon=1&amp;id_wtverticalmegamenu={$menu->id|intval}" id="del_icon">Remove</a>
						{/if}
					{/if}
						<script type="text/javascript">
						$(document).ready(function(){
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Position Of SubMenu' mod='wtverticalmegamenu'}</label>
		<div class="col-lg-9">
			<select class="form-control fixed-width-lg" name="align_sub" id="align_sub">
				<option value="wt-vm-sub-top">{l s='Top' mod='wtverticalmegamenu'}</option>
				<option value="wt-vm-sub-auto">{l s='Auto' mod='wtverticalmegamenu'}</option>
			</select>
			<script type="text/javascript">
				$(document).ready(function(){
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Width Of SubMenu' mod='wtverticalmegamenu'}</label>
		<div class="col-lg-9">
	...
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Class' mod='wtverticalmegamenu'}</label>
		<div class="col-lg-9">
			<input type="text" class="class" id="class" name="class" value="{if $menu->class}{$menu->class|escape:'html':'UTF-8'}{/if}"/>
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-lg-3">{l s='Active' mod='wtverticalmegamenu'}</label>
		<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
	...
	<div class="panel-footer">
		<input type="hidden" name="id_wtverticalmegamenu" id="id_wtverticalmegamenu" value="{if isset($menu->id)}{$menu->id|intval}{/if}"/>
