...
<div id="video_form">
	...
	<div id="video_hidden_controls" style="{if $id_video!=''}display:block{else}display:none{/if}">
		...
		<div class="out_width">
			...
			<input type="text" id="input_video_height" class="input_video_height" value="{if $heightv!=0}{$heightv|intval}{else}240{/if}"/>
		</div>
...
<div id="video_preview">
	...
	<div class="video-thumbnail-preview">{if $img_url!=''}
		<img src="{$img_url|escape:'html':'UTF-8'}" alt="image preview" width="320" height="240"/>
