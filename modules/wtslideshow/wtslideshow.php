...
class WtSlideshow extends Module
{
	private $html = '';
	public function __construct()
	{
		...
		$this->displayName = $this->l('WT Layer SlideShow');
		$this->description = $this->l('Show images slideshow to homepage.');
	}
	...
	private function prepareHook()
	{
		...
		$this->smarty->assign(array('wtslideshow_slides' => $slide_list));
		return true;
	}
	...
	public function hookdisplayHeader()
	{
		...
		$this->smarty->assign('wtslideshow_path', $this->_path);
	}
	...
	public function hookdisplayTopColumn()
	{
		...
		{
			if (!$this->isCached('wtslideshow.tpl', $this->getCacheId('wtslideshow')))
			{
				...
				if (!$this->prepareHook())
					return false;
				$this->smarty->assign(array('slier_option_arr' => $slier_option_arr));
			}
				if ($isMobile == 1 && $slier_option_arr['showmobile'] == 'false')
					return false;
				else
					return $this->display(__FILE__, 'wtslideshow.tpl', $this->getCacheId('wtslideshow'));
		}
	}
	...
	public function renderAddForm()
	{
		...
		$this->context->controller->addJS($this->_path.'views/js/layerslider.transitions.js');
		$this->context->controller->addJS($this->_path.'views/js/layerslider.kreaturamedia.jquery.js');
		$this->context->controller->addJs($this->_path.'views/js/admin/csadmin.js');
