	...
	{if $input.type == 'file'}
		...
		{if isset($background_image)}
			...
			<div class="col-lg-9">
				...
				<p><a href="{$link_delete_background|escape:'html':'UTF-8'}" id="img_delete_icon" class="delete_product_image btn btn-default"><i class="icon-trash"></i>{l s='Delete' mod='wtmanufacture'}</a></p>
			</div>
