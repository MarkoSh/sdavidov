...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_category_lang` (
  ...
  PRIMARY KEY (`id_wt_blog_category`,`id_lang`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_category_shop` (
  `id_wt_blog_category_shop`  int(11) NOT NULL auto_increment,
  `id_wt_blog_category` int(11) NOT NULL,
  `id_shop` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_wt_blog_category_shop`,`id_wt_blog_category`,`id_shop`)
)ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_comment_shop` (
  `id_wt_blog_comment_shop`  int(11) NOT NULL auto_increment,
  `id_wt_blog_comment` int(11) NOT NULL,
  `id_shop` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_wt_blog_comment_shop`,`id_wt_blog_comment`,`id_shop`)
)ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_media` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_post_lang` (
  ...
  PRIMARY KEY (`id_wt_blog_post`,`id_lang`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_post_shop` (
  `id_wt_blog_post_shop` int(11) NOT NULL auto_increment,
  `id_wt_blog_post` int(11) NOT NULL,
  `id_shop` int(11) NOT NULL,
  PRIMARY KEY (`id_wt_blog_post_shop`,`id_wt_blog_post`,`id_shop`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_post_category` (
  `id_wt_blog_post_category` int(11) NOT NULL,
  `id_wt_blog_category` int(11) DEFAULT NULL
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_post_related` (
  `id_post` int(11) NOT NULL,
  `related_post_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_post`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_product_related` (
  `id_post` int(11) NOT NULL,
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'wt_blog_imagetype`(
  `id_wt_blog_imagetype` int(11) NOT NULL auto_increment,
  `type_name` varchar(45) DEFAULT NULL,
  `width` varchar(45) DEFAULT NULL,
  `height` varchar(45) DEFAULT NULL,
  `type` varchar(45) DEFAULT NULL,
  `active` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_wt_blog_imagetype`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8';
