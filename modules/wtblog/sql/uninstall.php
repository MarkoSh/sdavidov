...
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_comment_shop`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_media`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_post`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_post_lang`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_post_category`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_post_related`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_post_shop`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_product_related`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_tag`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_post_tag`';
$sql[] = 'DROP TABLE IF EXISTS  `'._DB_PREFIX_.'wt_blog_imagetype`';
